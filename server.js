...
const knexProductos = require('./models/knex-productos');
const knexChat = require('./models/knex-chat');
...
let productos = new Contenedor(knexProductos, 'productos');
let chat = new Chat(knexChat, 'mensajes');
